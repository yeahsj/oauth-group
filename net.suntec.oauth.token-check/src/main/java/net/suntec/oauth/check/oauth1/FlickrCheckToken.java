...
public class FlickrCheckToken extends Oauth1CheckToken implements CheckToken {
	...
	String FL_CHECK_URL = "https://api.flickr.com/services/rest/?format=json&method=flickr.auth.oauth.checkToken&api_key=%s&auth_token=%s";

	public String getCheckURL(TokenInfo info) {
		//&nojsoncallback=1
		return String.format(FL_CHECK_URL, info.getApiKey() , info.getAccessToken() );
	}
